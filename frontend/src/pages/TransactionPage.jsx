...
import { UPDATE_TRANSACTION } from "../graphql/mutations/transcationMutation";
...
const TransactionPage = () => {
	...
	const [updateTransaction,{updating}] = useMutation(UPDATE_TRANSACTION)
    ...
    return (
        <div className="h-screen max-w-4xl mx-auto flex flex-col items-center">
          ...
          from-pink-500 to-pink-500 hover:from-pink-600 hover:to-pink-600"
					...
					disabled={updating}
                >
					{updating?"Updating Transaction...":"Update Transaction"}
                    {/* Update Transaction */}
                </button>
            </form>
        </div>
